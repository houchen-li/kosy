...
set(CMAKE_C_FLAGS "-march=armv8-a -mtune=generic -pipe -fexceptions -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -fPIC -Wall -Wextra -Wpedantic" CACHE STRING "C compiler flags")
set(CMAKE_CXX_FLAGS "${CMAKE_C_FLAGS} -stdlib=libc++" CACHE STRING "C++ compiler flags")
set(CMAKE_Fortran_FLAGS "-march=armv8-a -mtune=generic -fno-omit-frame-pointer -pedantic" CACHE STRING "Fortran compiler flags")
...
set(CMAKE_C_FLAGS_RELWITHDEBINFO "-O2 -g -DNDEBUG -fsanitize=address,undefined -ftree-vectorize" CACHE STRING "C compiler flags for release with debug info mode")
