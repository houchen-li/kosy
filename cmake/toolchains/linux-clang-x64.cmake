...
set(CMAKE_EXE_LINKER_FLAGS "-stdlib=libc++ -rtlib=compiler-rt --unwindlib=libgcc -lc++abi" CACHE STRING "Executable linker flags")
set(CMAKE_SHARED_LINKER_FLAGS "-stdlib=libc++ -rtlib=compiler-rt --unwindlib=libgcc -lc++abi" CACHE STRING "Shared linker flags")
set(CMAKE_MODULE_LINKER_FLAGS "-stdlib=libc++ -rtlib=compiler-rt --unwindlib=libgcc -lc++abi" CACHE STRING "Module linker flags")
