if(NOT DEFINED KOSY_IDE_FOLDER)
  set(KOSY_IDE_FOLDER ${PROJECT_NAME})
endif()

function(kosy_cxx_library)
  cmake_parse_arguments(PARSE_ARGV 0 KOSY_CXX_LIB
  ...
  list(FILTER _SRCS EXCLUDE REGEX ".*\\.(h|hpp|inc|cuh)")
  if(_SRCS STREQUAL "")
    set(_IS_INTERFACE 1)
  else()
    set(_IS_INTERFACE 0)
  ...
  if(NOT _IS_INTERFACE)
    ...
    target_compile_options(${KOSY_CXX_LIB_NAME} INTERFACE ${KOSY_CXX_LIB_COPTS})
  ...
  if(KOSY_ENABLE_INSTALL)
    ...
    install(TARGETS ${KOSY_CXX_LIB_NAME} EXPORT ${PROJECT_NAME}Targets
  ...
  add_library(${PROJECT_NAME}::${KOSY_CXX_LIB_NAME} ALIAS ${KOSY_CXX_LIB_NAME})
endfunction()

function(kosy_cxx_module)
  cmake_parse_arguments(PARSE_ARGV 0 KOSY_CXX_MODULE
    "DISABLE_INSTALL;PUBLIC;TESTONLY"
    "NAME"
  ...
  if(KOSY_ENABLE_INSTALL)
    file(RELATIVE_PATH _REL_PATH "${PROJECT_SOURCE_DIR}/src" "${CMAKE_CURRENT_SOURCE_DIR}")
    install(TARGETS ${KOSY_CXX_MODULE_NAME} EXPORT ${PROJECT_NAME}Targets
      FILE_SET CXX_MODULES DESTINATION modules/${_REL_PATH}
      RUNTIME DESTINATION ${CMAKE_INSTALL_BINDIR}
      LIBRARY DESTINATION ${CMAKE_INSTALL_LIBDIR}
      ARCHIVE DESTINATION ${CMAKE_INSTALL_LIBDIR}
    )
  ...
  add_library(${PROJECT_NAME}::${KOSY_CXX_MODULE_NAME} ALIAS ${KOSY_CXX_MODULE_NAME})
endfunction()
...
function(kosy_cxx_test)
  ...
  cmake_parse_arguments(PARSE_ARGV 0 KOSY_CXX_TEST
    ""
    "NAME"
